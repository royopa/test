...
for (k in 1:length(itens_monitor)){
  ...
  dfY <- readbase_ipca(itens=it_m, day="all", var=TRUE, tri=FALSE, initial.date = "2012-01-31")
...
write_xlsx(optimal, 
           "F:/DADOS/ASSET/MACROECONOMIA/1PIETRO/AUXILIARES/rotinas juliano/prev_ipca_atacado.xlsx", 
           col_names = TRUE)

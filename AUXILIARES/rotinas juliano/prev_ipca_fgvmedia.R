...
for (k in 1:length(itens)){
  ...
  dfX_all <- readbase_monitor(itens=it_m, media=TRUE, end=FALSE, last=FALSE, 
...
write_xlsx(optimal, 
           "F:/DADOS/ASSET/MACROECONOMIA/1PIETRO/AUXILIARES/rotinas juliano/prev_ipca_fgvmedia.xlsx", 
           col_names = TRUE)
